...
import com.example.goodplanet.constant.DangerousPermissions;
...
//    public static final int REQUEST_READ_PHONE_STATE = 10065;
    ...
    /**请求定位的权限*/
    public static final int REQUEST_LOCATION = 10069;
    /**
     * 检查应用是否拥有权限
...
//                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
    ...
    public static String getMessageContent(List<String> permissions){
        StringBuilder messageContent = new StringBuilder("检测到您未开启");
        for (int i = 0 ;i < permissions.size() ; i++){
            messageContent.append(getPermissionExplain(permissions.get(i)) + "权限");
        ...
        messageContent.append("请到系统设置中开启权限");
